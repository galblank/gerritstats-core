...
export default class OverviewTable extends React.Component {
    ...
    renderRow(index, overviewRecord) {
        ...
        const isHidden =
            overviewRecord.reviewCountPlus2 == 0
                && overviewRecord.reviewCountPlus1 == 0
                && overviewRecord.reviewCountMinus1 == 0
                && overviewRecord.reviewCountMinus2 == 0
                && overviewRecord.allCommentsWritten == 0
                && overviewRecord.commitCount ==0;
